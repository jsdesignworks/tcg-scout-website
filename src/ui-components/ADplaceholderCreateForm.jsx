...
export default function ADplaceholderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLocationcreated(initialValues.locationcreated);
    setUsericon(initialValues.usericon);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new ADplaceholder(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "ADplaceholderCreateForm")}
    >
      <TextField
        label="Title"
        isRequired={false}
