...
export default function ProductUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setYearcreated(cleanValues.yearcreated);
    setMarketprice(cleanValues.marketprice);
    setSet(cleanValues.set);
    setUntitledfield(cleanValues.untitledfield);
    setAskingprice(cleanValues.askingprice);
