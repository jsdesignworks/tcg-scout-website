...
export default function ReviewCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setReviewedby(initialValues.reviewedby);
    setReviewdate(initialValues.reviewdate);
    setReviewbody(initialValues.reviewbody);
    setReviewrating(initialValues.reviewrating);
    setReviewapproved(initialValues.reviewapproved);
