...
export declare type StreamerUpdateFormInputValues = {
    username?: string;
    name?: string;
    contactemail?: string;
    channel?: string;
...
export declare type StreamerUpdateFormValidationValues = {
...
export declare type StreamerUpdateFormOverridesProps = {
    StreamerUpdateFormGrid?: FormProps<GridProps>;
...
export declare type StreamerUpdateFormProps = React.PropsWithChildren<{
    overrides?: StreamerUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    streamer?: Streamer;
    onSubmit?: (fields: StreamerUpdateFormInputValues) => StreamerUpdateFormInputValues;
    onSuccess?: (fields: StreamerUpdateFormInputValues) => void;
    onError?: (fields: StreamerUpdateFormInputValues, errorMessage: string) => void;
    onCancel?: () => void;
    onChange?: (fields: StreamerUpdateFormInputValues) => StreamerUpdateFormInputValues;
    onValidate?: StreamerUpdateFormValidationValues;
} & React.CSSProperties>;
export default function StreamerUpdateForm(props: StreamerUpdateFormProps): React.ReactElement;
